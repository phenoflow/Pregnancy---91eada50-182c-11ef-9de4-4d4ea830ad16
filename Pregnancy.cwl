...
steps:
  ...
  pregnancy-isoimmunisation---primary:
    run: pregnancy-isoimmunisation---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  pregnancy-expression---primary:
    run: pregnancy-expression---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  pregnancy-vagin---primary:
    run: pregnancy-vagin---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  essential-pregnancy---primary:
    run: essential-pregnancy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  molar-pregnancy---primary:
    run: molar-pregnancy---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  social-pregnancy---primary:
    run: social-pregnancy---primary.cwl
    out:
    - output
    in:
      inputModule:
